function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 sm:p-4 md:p-8 sm:w-24 sm:h-24 md:w-36 md:h-36 sm:max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out hover:shadow-xl">
